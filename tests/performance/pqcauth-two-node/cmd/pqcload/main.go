...
func generate(arguments []string) {
	...
	classicGas := flags.Uint64("classic-gas", 90_000, "gas limit per classic transaction")
	hybridGas := flags.Uint64("hybrid-gas", 400_000, "gas limit per hybrid transaction")
	nativeGas := flags.Uint64("native-gas", 250_000, "gas limit per native transaction")
