...
type MsgUpdateSponsor struct {
	...
	// Explicitly removes the custom ticket issuer. This is separate from the
	// address field so existing clients that omit it retain the current value.
	ClearTicketIssuer bool `protobuf:"varint,6,opt,name=clear_ticket_issuer,json=clearTicketIssuer,proto3" json:"clear_ticket_issuer,omitempty"`
}
...
var fileDescriptor_22461c0ea8a50db3 = []byte{
	...
	,
}
...
func (m *MsgUpdateSponsor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ClearTicketIssuer", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
