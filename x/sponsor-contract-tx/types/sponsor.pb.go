...
type ContractSponsor struct {
	...
	// Generation identifies this sponsor lifecycle. Deleting a sponsor rotates
	// the generation, permanently invalidating tickets and usage from the
	// deleted lifecycle.
...
func (m *ContractSponsor) GetGeneration() uint64 {
	if m != nil {
		return m.Generation
	}
	return 0
...
type GenesisState struct {
	...
	// Persistent lifecycle generations, including tombstones for contracts whose
	// Sponsor and historical ticket/usage records have already been removed.
	ContractGenerations []*ContractGeneration `protobuf:"bytes,5,rep,name=contract_generations,json=contractGenerations,proto3" json:"contract_generations,omitempty"`
}
...
func (m *GenesisState) GetContractGenerations() []*ContractGeneration {
	if m != nil {
		return m.ContractGenerations
	}
	return nil
}

// ContractGeneration preserves the current Sponsor lifecycle generation for a
// contract independently of active Sponsor, ticket, and usage records.
type ContractGeneration struct {
	ContractAddress string `protobuf:"bytes,1,opt,name=contract_address,json=contractAddress,proto3" json:"contract_address,omitempty"`
	Generation      uint64 `protobuf:"varint,2,opt,name=generation,proto3" json:"generation,omitempty"`
}

func (m *ContractGeneration) Reset()         { *m = ContractGeneration{} }
func (m *ContractGeneration) String() string { return proto.CompactTextString(m) }
func (*ContractGeneration) ProtoMessage()    {}
func (*ContractGeneration) Descriptor() ([]byte, []int) {
	return fileDescriptor_eab4c65bac3c53c6, []int{2}
}
func (m *ContractGeneration) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ContractGeneration) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ContractGeneration.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ContractGeneration) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ContractGeneration.Merge(m, src)
}
func (m *ContractGeneration) XXX_Size() int {
	return m.Size()
}
func (m *ContractGeneration) XXX_DiscardUnknown() {
	xxx_messageInfo_ContractGeneration.DiscardUnknown(m)
}

var xxx_messageInfo_ContractGeneration proto.InternalMessageInfo

func (m *ContractGeneration) GetContractAddress() string {
	if m != nil {
		return m.ContractAddress
	}
	return ""
...
func (m *ContractGeneration) GetGeneration() uint64 {
	if m != nil {
		return m.Generation
	}
	return 0
...
type UserGrantUsage struct {
	...
	// Generation binds this usage to one sponsor lifecycle.
...
func (m *UserGrantUsage) GetGeneration() uint64 {
	if m != nil {
		return m.Generation
	}
	return 0
...
type PolicyTicket struct {
	...
	// Generation binds this ticket to one sponsor lifecycle. Tickets from a
	// deleted lifecycle can never become valid after the sponsor is recreated.
	Generation uint64 `protobuf:"varint,9,opt,name=generation,proto3" json:"generation,omitempty"`
}
...
func (m *PolicyTicket) GetGeneration() uint64 {
	if m != nil {
		return m.Generation
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*ContractGeneration)(nil), "doravota.sponsor.v1.ContractGeneration")
...
var fileDescriptor_eab4c65bac3c53c6 = []byte{
	...
	,
}
...
func (this *GenesisState) Equal(that interface{}) bool {
	...
	if len(this.ContractGenerations) != len(that1.ContractGenerations) {
		return false
	}
	for i := range this.ContractGenerations {
		if !this.ContractGenerations[i].Equal(that1.ContractGenerations[i]) {
			return false
		}
	}
	return true
}
func (this *ContractGeneration) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ContractGeneration)
	if !ok {
		that2, ok := that.(ContractGeneration)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *ContractSponsor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Generation != 0 {
		i = encodeVarintSponsor(dAtA, i, uint64(m.Generation))
		i--
		dAtA[i] = 0x48
	}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ContractGenerations) > 0 {
		for iNdEx := len(m.ContractGenerations) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ContractGenerations[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ContractGeneration) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ContractGeneration) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ContractGeneration) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ContractSponsor) Size() (n int) {
	...
	if m.Generation != 0 {
		n += 1 + sovSponsor(uint64(m.Generation))
	}
	return n
}
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.ContractGenerations) > 0 {
		for _, e := range m.ContractGenerations {
			l = e.Size()
			n += 1 + l + sovSponsor(uint64(l))
		}
	}
...
func (m *ContractGeneration) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ContractGenerations", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ContractGenerations = append(m.ContractGenerations, &ContractGeneration{})
			if err := m.ContractGenerations[len(m.ContractGenerations)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ContractGeneration) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ContractGeneration: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ContractGeneration: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
