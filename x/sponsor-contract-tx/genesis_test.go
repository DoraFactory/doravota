					...
					Sponsors: []*types.ContractSponsor{
						{
							...
							IsSponsored:     true,
							MaxGrantPerUser: []*sdk.Coin{
								{Denom: "peaka", Amount: sdkmath.NewInt(1000)},
							},
						},
						{
					...
					Sponsors: []*types.ContractSponsor{
						{
							...
							SponsorAddress:  sponsorAddr,
							IsSponsored:     true,
							MaxGrantPerUser: []*sdk.Coin{{Denom: "peaka", Amount: sdkmath.NewInt(1)}},
						},
					},
				}
			}(),
			...
			genesis: func() *types.GenesisState {
				...
				return &types.GenesisState{
					...
					UserGrantUsages: []*types.UserGrantUsage{{
						UserAddress:     suite.user1.String(),
						ContractAddress: suite.contractAddr1,
						TotalGrantUsed:  []*sdk.Coin{{Denom: "peaka", Amount: sdkmath.NewInt(1)}},
					}},
				}
			}(),
			expectErr: true,
			...
			genesis: func() *types.GenesisState {
				...
				return &types.GenesisState{
					...
					Sponsors: []*types.ContractSponsor{{
						...
						SponsorAddress:  sponsorAddr,
						IsSponsored:     true,
						MaxGrantPerUser: []*sdk.Coin{{Denom: "peaka", Amount: sdkmath.NewInt(10)}},
					}},
					UserGrantUsages: []*types.UserGrantUsage{{
						UserAddress:     suite.user1.String(),
						ContractAddress: suite.contractAddr1,
						TotalGrantUsed:  []*sdk.Coin{{Denom: "peaka", Amount: sdkmath.NewInt(11)}},
					}},
				}
			}(),
			expectErr: false,
...
func (suite *GenesisTestSuite) TestInitExportGenesis() {
		...
		Sponsors: []*types.ContractSponsor{
			{
				...
				IsSponsored:     true,
				MaxGrantPerUser: []*sdk.Coin{
					{Denom: "peaka", Amount: sdkmath.NewInt(5000)},
				},
			},
			{
		...
		UserGrantUsages: []*types.UserGrantUsage{
			{
				...
				TotalGrantUsed: []*sdk.Coin{
					{Denom: "peaka", Amount: sdkmath.NewInt(750)},
				},
	...
	suite.Require().True(usage1.TotalGrantUsed[0].Amount.Equal(sdkmath.NewInt(750)))
		...
		Sponsors: []*types.ContractSponsor{
			{
				...
				IsSponsored:     true,
				MaxGrantPerUser: []*sdk.Coin{
					{Denom: "peaka", Amount: sdkmath.NewInt(10000)},
				},
			},
		},
		UserGrantUsages: []*types.UserGrantUsage{
			{
				...
				ContractAddress: suite.contractAddr1,
				TotalGrantUsed: []*sdk.Coin{
					{Denom: "peaka", Amount: sdkmath.NewInt(250)},
				},
...
func (suite *GenesisTestSuite) TestExportGenesis_RoundTrip_Normalizes() {
	...
	genesis := &types.GenesisState{
		...
		Sponsors: []*types.ContractSponsor{{
			...
			IsSponsored:     true,
			MaxGrantPerUser: []*sdk.Coin{
				{Denom: "peaka", Amount: sdkmath.NewInt(1)},
				{Denom: "peaka", Amount: sdkmath.NewInt(2)},
			},
		}},
	}
	...
	suite.Require().Equal(sdkmath.NewInt(3), out[0].Amount)
}
...
func TestGenesisRoundTripAfterGrantLimitReduction(t *testing.T) {
	...
	require.Error(t, k.CheckUserGrantLimit(
		...
		user,
		contract,
		sdk.NewCoins(sdk.NewCoin(types.SponsorshipDenom, sdkmath.NewInt(1))),
	))
	...
	require.Equal(t, sdkmath.NewInt(50), reexported.Sponsors[0].MaxGrantPerUser[0].Amount)
	require.Len(t, reexported.UserGrantUsages, 1)
	require.Equal(t, sdkmath.NewInt(80), reexported.UserGrantUsages[0].TotalGrantUsed[0].Amount)
