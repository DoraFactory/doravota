...
func (minimalBankKeeper) SpendableCoins(ctx context.Context, addr sdk.AccAddress) sdk.Coins {
	return nil
}
func (minimalBankKeeper) SendCoins(ctx context.Context, fromAddr sdk.AccAddress, toAddr sdk.AccAddress, amt sdk.Coins) error {
	return nil
}
func (minimalBankKeeper) SendCoinsFromModuleToAccount(ctx context.Context, senderModule string, recipientAddr sdk.AccAddress, amt sdk.Coins) error {
	return nil
}
func (minimalBankKeeper) SendCoinsFromAccountToModule(ctx context.Context, senderAddr sdk.AccAddress, recipientModule string, amt sdk.Coins) error {
	return nil
}
func (minimalBankKeeper) MintCoins(ctx context.Context, moduleName string, amt sdk.Coins) error {
	return nil
}
func (minimalBankKeeper) BurnCoins(ctx context.Context, moduleName string, amt sdk.Coins) error {
	return nil
}
func (minimalBankKeeper) GetAllBalances(ctx context.Context, addr sdk.AccAddress) sdk.Coins {
	return nil
}
func (minimalBankKeeper) GetBalance(ctx context.Context, addr sdk.AccAddress, denom string) sdk.Coin {
	return sdk.Coin{}
}
...
func (minimalAuthKeeper) GetAccount(ctx context.Context, addr sdk.AccAddress) sdk.AccountI {
	return nil
}
func (minimalAuthKeeper) SetAccount(ctx context.Context, acc sdk.AccountI) {}
func (minimalAuthKeeper) NewAccountWithAddress(ctx context.Context, addr sdk.AccAddress) sdk.AccountI {
	return nil
}
func (minimalAuthKeeper) GetModuleAddress(moduleName string) sdk.AccAddress { return nil }
func (minimalAuthKeeper) GetModuleAccount(ctx context.Context, moduleName string) sdk.ModuleAccountI {
	return nil
}
...
func (minimalWasmKeeper) GetContractInfo(ctx context.Context, contractAddress sdk.AccAddress) *wasmtypes.ContractInfo {
	return &wasmtypes.ContractInfo{Creator: "creator", Admin: "admin"}
}
func (minimalWasmKeeper) QuerySmart(ctx context.Context, contractAddr sdk.AccAddress, req []byte) ([]byte, error) {
	return nil, nil
}
...
func TestAppModuleBeginBlock_GarbageCollect(t *testing.T) {
	...
	if _, ok := k.GetPolicyTicket(ctx, "c", "u", "d"); !ok {
...
func TestAppModule_GenesisRawJSONRoundTrip(t *testing.T) {
	...
	gs := &types.GenesisState{
		...
		Sponsors: []*types.ContractSponsor{
			{ContractAddress: contract1, CreatorAddress: creator, SponsorAddress: sp1, IsSponsored: true, MaxGrantPerUser: []*sdk.Coin{{Denom: types.SponsorshipDenom, Amount: sdkmath.NewInt(1)}}},
		...
		UserGrantUsages: []*types.UserGrantUsage{
			{UserAddress: user1, ContractAddress: contract1, TotalGrantUsed: []*sdk.Coin{{Denom: types.SponsorshipDenom, Amount: sdkmath.NewInt(3)}}},
		},
	}
...
func TestAppModuleBeginBlock_GCRespectsCap(t *testing.T) {
	...
	for _, dg := range []string{"d1", "d2", "d3"} {
		if _, ok := k.GetPolicyTicket(ctx, "c", "u", dg); ok {
			remaining++
		}
	}
