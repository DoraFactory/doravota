	...
	testCases := []struct {
		...
		},
		{
			message: &MsgRecoverKey{
				...
				ExpectedRecoveryDelayBlocks: DefaultRecoveryDelayBlocks,
...
func TestLifecycleMessageValidateBasicRejectsMalformedInputs(t *testing.T) {
	...
	testCases := []struct {
		...
		{"cancel recovery owner", &MsgCancelRecovery{Owner: "invalid"}},
		{"cancel recovery identifiers", &MsgCancelRecovery{Owner: owner}},
