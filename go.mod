...
require (
	...
	github.com/cosmos/cosmos-sdk/x/params v0.0.0-00010101000000-000000000000
...
// Wasmd v0.70.3 compatibility patches; see third_party provenance.
replace github.com/CosmWasm/wasmd => ./third_party/wasmd-v055-compat

// Legacy Wasm parameter declarations and historical governance proposal decoding only.
replace github.com/cosmos/cosmos-sdk/x/params => ./third_party/cosmos-sdk-x-params-compat

// Official IBC-Go #9011: SDK 0.55 / CometBFT 0.40 adaptation.
// A replacement is required: Wasmd's v11.1.0 requirement otherwise wins MVS
// over this v11.0.0-based pseudo-version and silently restores the old APIs.
replace github.com/cosmos/ibc-go/v11 => github.com/cosmos/ibc-go/v11 v11.0.0-20260812140710-ae841d41a589
