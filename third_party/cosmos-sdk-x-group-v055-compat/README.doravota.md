...
Compatibility changes (see PROVENANCE.md and upstream-diff.patch):
...
- the retired group depinject provider and simsx WeightedOperationsX factories
  are omitted; legacy simulation SharedState is retained locally;
